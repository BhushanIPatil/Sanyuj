...
export default function Page() {
  return <LegalShell title="Terms of Use" updated="September 11, 2026">
    <p>By using Sanyuj, you agree to these terms. The service lets you browse offers, announcements, events and local services without a public account.</p>
    <LegalSection title="Offers and announcements">
      ...
      <p>Service listings provide information and contact links. Sanyuj does not arrange service bookings. Links may take you to external websites, whose terms apply there.</p>
    </LegalSection>
