...
export default function Page() {
  return <LegalShell title="Privacy Policy" updated="September 11, 2026">
    ...
    <LegalSection title="Retired features">
      <p>Business listings, listing requests, customer accounts, and account-based click tracking have been retired. Their database records are removed as part of the retirement rollout. Historical backups and infrastructure logs follow their configured retention periods.</p>
    </LegalSection>
  </LegalShell>;
}
