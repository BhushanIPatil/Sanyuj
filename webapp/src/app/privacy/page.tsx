...
export default function Page() {
  return <LegalShell title="Privacy Policy" updated="September 11, 2026">
    ...
    <LegalSection title="Requests and follow-up">
      <p>When you submit a request, we store your name, phone number or email, image and any details you provide so our team can review it and follow up. Request images, contact details and internal follow-up notes are private to authorized administrators. A request is not published automatically.</p>
    </LegalSection>
